...
if __name__ == "__main__":
    ...
    parser.add_argument("--manifest_path", default='/home/pggemmaaward/new-disk/IndicVoices-R/VoiceCraft/datasets/ivr/final_metadata.jsonl', type=str, required=False, help="Base directory for manifests")
    parser.add_argument("--model_path", default='/home/pggemmaaward/new-disk/IndicVoices-R/VoiceCraft/logs/ivr/e830M/best_bundle.pth', type=str, required=True, help="Path to the model file")
    parser.add_argument("--output_dir", default='/home/pggemmaaward/new-disk/IndicVoices-R/VoiceCraft/logs/ivr/e830M/output', type=str, required=True, help="Directory to save output files")
