...
def get_args():
    ...
    parser.add_argument("--manifest_fn", type=str, default="data/Hindi/metadata_test.json")
    parser.add_argument("--audio_root", type=str, default="data/Hindi/wavs")
    parser.add_argument("--exp_dir", type=str, default="logs/ivr/e830M")
    ...
    parser.add_argument("--signature", type=str, default=None, help="checkpoints")
