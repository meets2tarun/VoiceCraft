...
def process_file(file):
    ...
    segment_len = get_codec_len(osp.join('datasets/ivr/xs/encodec_16khz_4codebooks', file))
...
if __name__ == '__main__':
    ...
    code_files = set(os.listdir('datasets/ivr/xs/encodec_16khz_4codebooks'))
    phoneme_files = set(os.listdir('datasets/ivr/xs/phonemes'))
